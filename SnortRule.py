...
class SnortRule(object):
  ...
  content_modifiers = ['nocase','rawbytes','depth','offset','distance','within','http_client_body','http_cookie','http_raw_cookie','http_header','http_raw_header','http_method','http_uri','http_raw_uri','http_stat_code','http_stat_msg','fast_pattern']
  argless_keywords=['http_method', 'ftpbounce','file_data','nocase','rawbytes','dce_stub_data','fast_pattern','http_client_body', 'http_header','http_raw_cookie','http_raw_header','http_method','http_uri','http_stat_code','http_stat_msg','http_cookie']
